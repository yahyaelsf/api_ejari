    ...
    <div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__body">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="datatable">
                ...
                <tr>
                    <th>#</th>
                    <th width="40%">@lang('general.name')</th>
    ...
    <script>
        ...
        table.DataTable({
            ...
            columns: [
                ...
                {data: 'enabled_html', searchable: false, sortable: false, visible: {{ (int) auth()->user()->can('categories-status') }}},
                {
                    data: 'actions_column',
                    searchable: false,
                    sortable: false,
                    responsivePriority: -1,
                    visible: {{ (int) (auth()->user()->can('categories-store') || auth()->user()->can('categories-delete')) }}
                },
            ]
        });
        ...
        function openModal(id = '') {
            $.get('{{ route('admin.categories.form') }}?id=' + id, function (data) {
