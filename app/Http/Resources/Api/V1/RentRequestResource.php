...
class RentRequestResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'furnished' => $this->e_furnished,
            'status' => $this->e_status,
            'finishing_quality' => $this->e_finishing_quality,
            'additional_features' => $this->s_additional_features,
            'surrounding_area' => $this->s_surrounding_area,
            'water_conservation' => $this->e_water_conservation,
