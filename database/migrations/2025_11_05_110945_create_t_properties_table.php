...
class CreateTPropertiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_properties', function (Blueprint $table) {
            $table->id('pk_i_id');
            ...
            $table->text('s_conditions')->nullable();
    ...
    {
        Schema::dropIfExists('t_properties');
    }
}
